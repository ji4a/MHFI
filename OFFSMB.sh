...
chown -R $USERNAME:$USERNAME /OFFSERVER
chmod -R 755 /OFFSERVER
...
chown :MHBT_GROUP /OFFSERVER
chmod g+rw /OFFSERVER

# ADD USERS TO GROUP
usermod -aG MHBT_GROUP admin
usermod -aG MHBT_GROUP roy

echo "GROUP created and users added to the group with read and write permissions on /OFFSERVER folder."
